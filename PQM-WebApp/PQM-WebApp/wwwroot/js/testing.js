...
const createAgeGroupChart = () => {
    $.get(`/api/AggregatedValues/Variables?year=${year}&quarter=${quarter}&month=${month}&provinceCode=${provinceCode}&districtCode=${districtCode}&indicatorGroup=Testing&groupBy=AgeGroup`,
        function (response) {
...
const createGenderChart = () => {
    $.get(`/api/AggregatedValues/Variables?year=${year}&quarter=${quarter}&month=${month}&provinceCode=${provinceCode}&districtCode=${districtCode}&indicatorGroup=Testing&groupBy=Gender`,
        function (response) {
...
const createKeyPopulationsChart = () => {
    $.get(`/api/AggregatedValues/Variables?year=${year}&quarter=${quarter}&month=${month}&provinceCode=${provinceCode}&districtCode=${districtCode}&indicatorGroup=Testing&groupBy=KeyPopulation`,
        function (response) {
...
const createClinicsChart = () => {
    $.get(`/api/AggregatedValues/Variables?year=${year}&quarter=${quarter}&month=${month}&provinceCode=${provinceCode}&districtCode=${districtCode}&indicatorGroup=Testing&groupBy=Site`,
        function (response) {
...
const initIndicators = () => {
    ...
    $.get(`/api/AggregatedValues/IndicatorValues?indicatorGroup=Testing&year=${year}&quater=${quarter}&month=${month}&provinceCode=${provinceCode}&districtCode=${districtCode}`
