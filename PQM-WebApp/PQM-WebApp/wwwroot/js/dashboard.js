...
function indicator(name, value, valueColor, info, trend, hrTag) {
...
function initTestingIndicators() {
    $("#testing").append(indicator('HTS Positive', '252', 'red', 'red', { direction: -1, color: 'green' }, true));
    $("#testing").append(indicator('%HIV+ referred', '92%', 'green', null, { direction: 1, color: 'green' }, true));
    $("#testing").append(indicator('%HTS recent', '20%', 'orange', null, { direction: -1, color: 'green' }, false));
}

function initPrEPIndicators() {
    $("#prep").append(indicator('PrEP_New', '1,276', 'red', null, { direction: -1, color: 'green' }, true));
    $("#prep").append(indicator('PrEP_Curr', '1,925', 'green', null, { direction: 1, color: 'green' }, true));
    $("#prep").append(indicator('%PrEP_3M', '92%', 'green', null, { direction: 1, color: 'green' }, false));
}

function initTreatmentIndicators() {
    $("#treatment").append(indicator('TX_Curr', '498', 'red', null, { direction: 1, color: 'green' }, true));
    $("#treatment").append(indicator('TX_New', '235', 'green', null, { direction: 1, color: 'green' }, true));
    $("#treatment").append(indicator('MMD', '20', 'green', null, { direction: 1, color: 'green' }, true));
    $("#treatment").append(indicator('IT (Interruption in Treatment)', '24', 'green', null, { direction: 1, color: 'green' }, true));
    $("#treatment").append(indicator('% VL unsupressed', '0.05%', 'green', null, { direction: 1, color: 'green' }, true));
    $("#treatment").append(indicator('TB_PREW', '129', 'green', null, { direction: 1, color: 'green' }, false));
}

function initDrugsIndicators() {
    $("#drugs").append(indicator('%ARV drug consumption', '98%', 'green', null, { direction: 1, color: 'green' }, true));
    $("#drugs").append(indicator('%ARV drugs that have MOS', '79%', 'orange', null, { direction: 1, color: 'green' }, false));
}

function initSHIIndicators() {
    $("#shi").append(indicator('Patients do not </br> have a SHI card', '13', 'red', null, { direction: -1, color: 'green' }, true));
    $("#shi").append(indicator('TX_Curr using ARV from SHI', '459', 'green', null, { direction: 1, color: 'green' }, true));
    $("#shi").append(indicator('TX_Curr receiving VL test from SHI', '441', 'green', 'red', { direction: 1, color: 'green' }, true));
    $("#shi").append(indicator('% of TX_Curr receiving </br> ARV MMD having a SHI card', '97%', 'green', null, { direction: 1, color: 'green' }, false));
}

function initServiceQualityIndicators() {
    $("#service-quality").append(indicator('% clients know their VL status', '77%', 'red', 'red', { direction: -1, color: 'green' }, true));
    $("#service-quality").append(indicator('% of clients experience stigma', '08%', 'green', null, { direction: 1, color: 'red' }, true));
    $("#service-quality").append(indicator('% clients experience IPV/coercion </br> during testing services', '04%', 'green', null, { direction: -1, color: 'green' }, true));
    $("#service-quality").append(indicator('% of clients seeking services at private clinics', '47%', 'green', null, { direction: -1, color: 'green' }, true));
    $("#service-quality").append(indicator('%HTS_TST_1st_Time', '04%', 'green', null, { direction: 1, color: 'red' }, false));
}
...
function initPersonTypeChart() {
    $("#person-type-char").kendoChart({
        ...
        categoryAxis: {
            categories: ["FSWs", "MSM", "Other", "PWID", "SDCs", "TGW"]
        }
    });
}
