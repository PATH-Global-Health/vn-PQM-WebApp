{
    ...
    function initTestingIndicators() {
        $("#testing").append(fakeIndicator('HTS Positive', '252', 'red', 'red', { direction: -1, color: 'green' }, true));
        $("#testing").append(fakeIndicator('%HIV+ referred', '92%', 'green', null, { direction: 1, color: 'green' }, true));
        $("#testing").append(fakeIndicator('%HTS recent', '20%', 'orange', null, { direction: -1, color: 'green' }, false));
    }
